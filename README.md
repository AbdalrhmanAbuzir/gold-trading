...
[![Auth](https://img.shields.io/badge/Security-JWT_Tokens-green.svg)](#)
...
*   🛡️ **Administrators:** Oversee complete platform operations, approve user identity verification requests, and monitor marketplace integrity.
...
├── frontend/
│   └── gold/
│       ├── src/          # React components, Redux slices, API service layers
...
└── backend/
    ...
    │   ├── Data/         # DbContext initialization & schema migrations
    │   ├── Program.cs    # Application pipeline & Dependency Injection (DI)
    │   └── ...
    └── gold.sln          # Visual Studio Solution File
